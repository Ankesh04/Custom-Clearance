        ...
        <div className="login-page-container">
            ...
            <div className="visual-side">
                <div className="visual-side-content">
                 ...
                 <img src="/src/assets/images/login-background.png" alt="Global logistics illustration" className="visual-side-bg-image" />
            </div>
            ...
            <div className="form-side">
                <div className="form-wrapper">
                    ...
                    <p className="form-subtitle">
                        {isLoginView ? 'Login to access your dashboard' : 'Join us to streamline your customs process'}
                    </p>
                    ...
                    <form className="auth-form">
                        ...
                        <div className="input-group">
                            ...
                            <div className="password-wrapper">
                             ...
                             {!isLoginView && <p className="helper-text">Password must be at least 8 characters long.</p>}
                        </div>
